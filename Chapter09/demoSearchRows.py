...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 240, 121, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.lineEditPassword = QtWidgets.QLineEdit(Dialog)
        self.lineEditPassword.setGeometry(QtCore.QRect(180, 240, 241, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.pushButtonSearch.setGeometry(QtCore.QRect(200, 160, 101, 23))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButtonSearch.setFont(font)
        self.pushButtonSearch.setObjectName("pushButtonSearch")
        self.labelResponse = QtWidgets.QLabel(Dialog)
        self.labelResponse.setGeometry(QtCore.QRect(20, 200, 411, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
